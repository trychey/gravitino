...
class TestLocalFilesystem(unittest.TestCase):
    ...
    def test_cache(self, *mock_methods):
        if self._options.get(GVFSConfig.AUTH_TYPE) != GVFSConfig.TOKEN_AUTH_TYPE:
            ...
            with patch(
                ...
                extra_options = self._options.copy()
                extra_options[GVFSConfig.CACHE_SIZE] = 1
                extra_options[GVFSConfig.CACHE_EXPIRED_TIME] = 1
    ...
    def test_ls(self, *mock_methods):
        ...
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=mock_base.mock_get_fileset_context(
                "test_ls", f"{self._fileset_dir}/test_ls", actual_paths
            ),
        ) as mock_fileset:
            local_fs = LocalFileSystem()
            local_fs.mkdir(fileset_storage_location)
    ...
    def test_info(self, *mock_methods):
        ...
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=mock_base.mock_get_fileset_context(
                "test_info", f"{self._fileset_dir}/test_info", actual_paths
            ),
        ) as mock_fileset:
            self.assertTrue(fs.exists(fileset_virtual_location))

        dir_virtual_path = fileset_virtual_location + "/test_1"
        actual_paths = [fileset_storage_location + "/test_1"]
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=mock_base.mock_get_fileset_context(
                "test_info", f"{self._fileset_dir}/test_info", actual_paths
        ...
        actual_paths = [fileset_storage_location + "/test_file_1.par"]
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=mock_base.mock_get_fileset_context(
                "test_info", f"{self._fileset_dir}/test_info", actual_paths
    ...
    def test_exist(self, *mock_methods):
        ...
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=mock_base.mock_get_fileset_context(
                "test_exist", f"{self._fileset_dir}/test_exist", actual_paths
            ),
        ) as mock_fileset:
            self.assertTrue(fs.exists(fileset_virtual_location))
    ...
    def test_cp_file(self, *mock_methods):
        ...
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=mock_base.mock_get_fileset_context(
                "test_cp_file", f"{self._fileset_dir}/test_cp_file", actual_paths
            ),
        ) as mock_fileset:
            self.assertTrue(fs.exists(fileset_virtual_location))
        ...
        actual_paths1 = [fileset_storage_location + "/test_cp_file_1.par"]
        dst_context = mock_base.mock_get_fileset_context(
            "test_cp_file", f"{self._fileset_dir}/test_cp_file", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
    ...
    def test_mv(self, *mock_methods):
        ...
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=mock_base.mock_get_fileset_context(
                "test_mv", f"{self._fileset_dir}/test_mv", actual_paths
            ),
        ) as mock_fileset:
            self.assertTrue(fs.exists(fileset_virtual_location))
        ...
        actual_paths1 = [fileset_storage_location + "/test_cp_file_1.par"]
        dst_context = mock_base.mock_get_fileset_context(
            "test_mv", f"{self._fileset_dir}/test_mv", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
        ...
        actual_paths2 = [fileset_storage_location + "/another_dir/test_file_2.par"]
        dst_context1 = mock_base.mock_get_fileset_context(
            "test_mv", f"{self._fileset_dir}/test_mv", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
        ...
        actual_paths3 = [fileset_storage_location + "/not_exist/test_file_2.par"]
        dst_context2 = mock_base.mock_get_fileset_context(
            "test_mv", f"{self._fileset_dir}/test_mv", actual_paths3
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
    ...
    def test_rm(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_rm", f"{self._fileset_dir}/test_rm", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
        ...
        # test delete file
        file_virtual_path = fileset_virtual_location + "/test_file_1.par"
        actual_paths1 = [fileset_storage_location + "/test_file_1.par"]
        context2 = mock_base.mock_get_fileset_context(
            "test_rm", f"{self._fileset_dir}/test_rm", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
        ...
        actual_paths2 = [fileset_storage_location + "/sub_dir"]
        context3 = mock_base.mock_get_fileset_context(
            "test_rm", f"{self._fileset_dir}/test_rm", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
    ...
    def test_rm_file(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_rm_file", f"{self._fileset_dir}/test_rm_file", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location + "/test_file_1.par"]
        context2 = mock_base.mock_get_fileset_context(
            "test_rm_file", f"{self._fileset_dir}/test_rm_file", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
        ...
        actual_paths2 = [fileset_storage_location + "/sub_dir"]
        context3 = mock_base.mock_get_fileset_context(
            "test_rm_file", f"{self._fileset_dir}/test_rm_file", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context3,
    ...
    def test_rmdir(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_rmdir", f"{self._fileset_dir}/test_rmdir", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location + "/test_file_1.par"]
        context2 = mock_base.mock_get_fileset_context(
            "test_rmdir", f"{self._fileset_dir}/test_rmdir", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
        ...
        actual_paths2 = [fileset_storage_location + "/sub_dir"]
        context3 = mock_base.mock_get_fileset_context(
            "test_rmdir", f"{self._fileset_dir}/test_rmdir", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context3,
    ...
    def test_open(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_open", f"{self._fileset_dir}/test_open", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location + "/test_file_1.par"]
        context2 = mock_base.mock_get_fileset_context(
            "test_open", f"{self._fileset_dir}/test_open", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
        ...
        actual_paths2 = [fileset_storage_location + "/sub_dir"]
        context3 = mock_base.mock_get_fileset_context(
            "test_open", f"{self._fileset_dir}/test_open", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context3,
    ...
    def test_mkdir(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_mkdir", f"{self._fileset_dir}/test_mkdir", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location + "/not_exist/sub_dir"]
        context2 = mock_base.mock_get_fileset_context(
            "test_mkdir", f"{self._fileset_dir}/test_mkdir", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
        ...
        actual_paths2 = [fileset_storage_location + "/not_exist/sub_dir"]
        context3 = mock_base.mock_get_fileset_context(
            "test_mkdir", f"{self._fileset_dir}/test_mkdir", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context3,
    ...
    def test_makedirs(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_makedirs", f"{self._fileset_dir}/test_makedirs", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location + "/not_exist/sub_dir"]
        context2 = mock_base.mock_get_fileset_context(
            "test_makedirs", f"{self._fileset_dir}/test_makedirs", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
    ...
    def test_created(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_created", f"{self._fileset_dir}/test_created", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        # test mkdir dir which exists
        dir_virtual_path = fileset_virtual_location + "/sub_dir"
        actual_paths1 = [fileset_storage_location + "/sub_dir"]
        context2 = mock_base.mock_get_fileset_context(
            "test_created", f"{self._fileset_dir}/test_created", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
    ...
    def test_modified(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_modified", f"{self._fileset_dir}/test_modified", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location + "/sub_dir"]
        context2 = mock_base.mock_get_fileset_context(
            "test_modified", f"{self._fileset_dir}/test_modified", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
    ...
    def test_cat_file(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_cat_file", f"{self._fileset_dir}/test_cat_file", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location + "/test_file_1.par"]
        context2 = mock_base.mock_get_fileset_context(
            "test_cat_file", f"{self._fileset_dir}/test_cat_file", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
        ...
        actual_paths2 = [fileset_storage_location + "/sub_dir"]
        context3 = mock_base.mock_get_fileset_context(
            "test_cat_file", f"{self._fileset_dir}/test_cat_file", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context3,
    ...
    def test_get_file(self, *mock_methods):
        ...
        context1 = mock_base.mock_get_fileset_context(
            "test_get_file", f"{self._fileset_dir}/test_get_file", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location + "/test_file_1.par"]
        context2 = mock_base.mock_get_fileset_context(
            "test_get_file", f"{self._fileset_dir}/test_get_file", actual_paths1
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context2,
        ...
        actual_paths2 = [fileset_storage_location + "/sub_dir"]
        context3 = mock_base.mock_get_fileset_context(
            "test_get_file", f"{self._fileset_dir}/test_get_file", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context3,
    ...
    def test_convert_actual_path(self, *mock_methods):
        ...
        mock_context: FilesetContextDTO = FilesetContextDTO(
            ...
            _actual_paths=[hdfs_fileset.storage_location() + "/actual_path"],
        )
        ...
        mock_local_context: FilesetContextDTO = FilesetContextDTO(
            ...
            _actual_paths=[local_fileset.storage_location() + "/actual_path"],
        )
    ...
    def test_pandas(self, *mock_methods):
        ...
        actual_paths = [fileset_storage_location + "/test.parquet"]
        context1 = mock_base.mock_get_fileset_context(
            "test_pandas", f"{self._fileset_dir}/test_pandas", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
        ...
        actual_paths1 = [fileset_storage_location]
        context2 = mock_base.mock_get_fileset_context(
            "test_pandas", f"{self._fileset_dir}/test_pandas", actual_paths1
        )
        actual_paths2 = [fileset_storage_location + "/test.csv"]
        context3 = mock_base.mock_get_fileset_context(
            "test_pandas", f"{self._fileset_dir}/test_pandas", actual_paths2
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
    ...
    def test_pyarrow(self, *mock_methods):
        ...
        actual_paths = [fileset_storage_location + "/test.parquet"]
        context1 = mock_base.mock_get_fileset_context(
            "test_pyarrow", f"{self._fileset_dir}/test_pyarrow", actual_paths
        )
        with patch(
            "gravitino.catalog.fileset_catalog.FilesetCatalog.get_fileset_context",
            return_value=context1,
